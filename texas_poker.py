...
hand = PokerTable()
print(hand.board)
print(hand.player_list[0].best_hand, hand.player_list[0].hand, hand.player_list[0].get_hand_value())
print(hand.player_list[1].best_hand, hand.player_list[1].hand, hand.player_list[1].get_hand_value())
# table = PokerTable(
